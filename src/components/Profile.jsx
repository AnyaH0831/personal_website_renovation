                ...
                <div className="flex justify-center gap-4 flex-wrap">
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-7 h-7">
                            ...
                            <polyline points="22,6 12,13 2,6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/>
                        </svg>
                    </a>
                </div>

                {/* Arrow */}
                <a href="#experience" className="mt-16 animate-bounce block cursor-pointer" aria-label="Scroll to experience">
                    <svg className='w-8 h-8 mx-auto text-pacific-cyan hover:text-cherry-rose transition-colors' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
